...
public enum NimbleExceptionMessageCode {
    ...
    FORBIDDEN_NOT_DOCUMENT_PARTICIPANT("FORBIDDEN.notDocumentParticipant"),
    FORBIDDEN_NOT_ORDER_BUYER("FORBIDDEN.notOrderBuyer"),
    FORBIDDEN_NOT_COLLABORATION_GROUP_OWNER("FORBIDDEN.notCollaborationGroupOwner"),
    FORBIDDEN_NOT_PROCESS_CONFIGURATION_PARTNER("FORBIDDEN.notProcessConfigurationPartner"),
