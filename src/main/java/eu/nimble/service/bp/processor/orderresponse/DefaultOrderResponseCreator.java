...
public class DefaultOrderResponseCreator  implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        if(executionType == ExecutionConfiguration.TypeEnum.JAVA) {
            ...
            orderResponse  = (OrderResponseSimpleType) businessProcessApplication.createDocument(seller, buyer, content, ProcessDocumentMetadata.TypeEnum.ORDERRESPONSE, order.getID());
