...
public class DefaultTransportExecutionPlanProcessor implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        ExecutionConfiguration executionConfiguration = ExecutionConfigurationDAOUtility.getExecutionConfiguration(buyer, execution.getProcessInstance().getProcessDefinitionId(), ProcessConfiguration.RoleTypeEnum.SELLER, "TRANSPORT_EXECUTION_PLAN",
        ...
        if(executionType == ExecutionConfiguration.ExecutionTypeEnum.JAVA) {
            ...
            businessProcessApplication.saveDocument(processContextId,processInstanceId, buyer, seller,creatorUserID, transportExecutionPlan, relatedProducts, relatedProductCategories, initiatorFederationId, responderFederationId);
