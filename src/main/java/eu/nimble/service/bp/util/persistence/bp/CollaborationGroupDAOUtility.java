...
public class CollaborationGroupDAOUtility {
    ...
    public static boolean isCollaborationGroupArchivable(CollaborationGroup collaborationGroup) {
        return collaborationGroup.getAssociatedProcessInstanceGroups().stream().noneMatch(processInstanceGroup ->
                processInstanceGroup.getStatus().equals(ProcessInstanceGroup.StatusEnum.INPROGRESS));
    }
