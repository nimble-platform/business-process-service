...
public class Test5_NegotiationResponse implements SeleniumInterface {
    @Override
    public void execute() {
        //Launch the website
        ...
        // Response
        Select response = new Select(wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/nimble-app/product-bp-options/negotiation/quotation/div[1]/select"))));
        response.selectByVisibleText("Accepted");
        // Send
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/nimble-app/product-bp-options/negotiation/quotation/div[2]/button"))).click();
