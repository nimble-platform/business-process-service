...
public class Test27_BinaryContentTest {
    ...
    public void test3_updateProcessInstance() throws Exception {
        ...
        BinaryObjectType binaryObjectType = Serializer.getDefaultObjectMapper().readValue(binaryObjectTypeString, BinaryObjectType.class);
        ...
        itemInformationRequest = Serializer.getDefaultObjectMapper().readValue(mvcResult.getResponse().getContentAsString(), ItemInformationRequestType.class);
