...
public class TestConfig {
    public final static String responderPersonId = "704";
    public final static String initiatorPersonId = "1337";
    ...
    public final static String federationId = "TEST_INSTANCE";
