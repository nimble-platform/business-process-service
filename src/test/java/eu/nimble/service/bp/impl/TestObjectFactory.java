...
public class TestObjectFactory {
    ...
    public static Process createProcess() {
        ...
        process.setProcessName("OrderTest");
        process.setProcessID(processID);
        process.setBpmnContent(getBPMNContent());
    ...
    private static String getBPMNContent() {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "    <bpmn:serviceTask id=\"Task_OrderToSeller\" name=\"Order to Seller\" camunda:class=\"eu.nimble.service.bp.processor.order.TestOrderProcessor\">\n" +
                "      <bpmn:extensionElements>\n" +
                "        <camunda:inputOutput>\n" +
                ...
                "    </bpmn:userTask>\n" +
                "    <bpmn:serviceTask id=\"Task_OrderResponseToBuyer\" name=\"Order Response to Buyer\" camunda:class=\"eu.nimble.service.bp.processor.orderresponse.TestOrderResponseProcessor\">\n" +
                "      <bpmn:extensionElements>\n" +
                "        <camunda:inputOutput>\n" +
